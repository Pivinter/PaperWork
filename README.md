...
#### 4️⃣ **Deploy to Docker Hub** (тільки на main)
```yaml
...
| Кількість deploy/тиждень | 1-2 | 10-20 | ⬆️ 900% |
...
Цей проект створено в навчальних цілях для виконання курсової роботи з дисципліни «Розгортання інформаційних систем».

---

**Дата створення**: Жовтень 2025

*Made with ❤️ using VueJS, Docker, and GitHub Actions*
